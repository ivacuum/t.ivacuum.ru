...
if (false === load_constants($bb_cfg['apc_prefix']))
{
	set_constants($bb_cfg['apc_prefix'], [
		...
		'AUTH_ACCESS_SNAP_TABLE'   => 'bb_auth_access_snap',
		'AUTH_ACCESS_TABLE'        => 'bb_auth_access',
		'BANLIST_TABLE'            => 'bb_banlist',
		'BT_DLSTATUS_MAIN_TABLE'   => 'bb_bt_dlstatus_main',
		'BT_DLSTATUS_NEW_TABLE'    => 'bb_bt_dlstatus_new',
		'BT_DLSTATUS_SNAP_TABLE'   => 'bb_bt_dlstatus_snap',
		'BT_DLSTATUS_TABLE'        => 'bb_bt_dlstatus_main',
		'BT_LAST_TORSTAT_TABLE'    => 'bb_bt_last_torstat',
		'BT_LAST_USERSTAT_TABLE'   => 'bb_bt_last_userstat',
		'BT_TORHELP_TABLE'         => 'bb_bt_torhelp',
		'BT_TORSTAT_TABLE'         => 'bb_bt_torstat',
		'BT_TRACKER_SNAP_TABLE'    => 'bb_bt_tracker_snap',
		'BT_USER_SETTINGS_TABLE'   => 'bb_bt_user_settings',
		'CATEGORIES_TABLE'         => 'bb_categories',
		'CONFIG_TABLE'             => 'bb_config',
		'CONFIRM_TABLE'            => 'bb_confirm',
		'CRON_TABLE'               => 'bb_cron',
		'DATASTORE_TABLE'          => 'bb_datastore',
		'DISALLOW_TABLE'           => 'bb_disallow',
		'EXTENSION_GROUPS_TABLE'   => 'bb_extension_groups',
		'EXTENSIONS_TABLE'         => 'bb_extensions',
		'FLAG_TABLE'               => 'bb_flags',
		'FORUMS_TABLE'             => 'bb_forums',
		'GROUPS_TABLE'             => 'bb_groups',
		'LOG_TABLE'                => 'bb_log',
		'POSTS_SEARCH_TABLE'       => 'bb_posts_search',
		'POSTS_TABLE'              => 'bb_posts',
		'POSTS_TEXT_TABLE'         => 'bb_posts_text',
		'POSTS_HTML_TABLE'         => 'bb_posts_html',
		'PRIVMSGS_TABLE'           => 'bb_privmsgs',
		'PRIVMSGS_TEXT_TABLE'      => 'bb_privmsgs_text',
		'QUOTA_LIMITS_TABLE'       => 'bb_quota_limits',
		'QUOTA_TABLE'              => 'bb_attach_quota',
		'RANKS_TABLE'              => 'bb_ranks',
		'SEARCH_QUERIES_TABLE'     => 'bb_search_queries',
		'SEARCH_REBUILD_TABLE'     => 'bb_search_rebuild',
		'SEARCH_TABLE'             => 'bb_search_results',
		'SESSIONS_TABLE'           => 'bb_sessions',
		'SMILIES_TABLE'            => 'bb_smilies',
		'TOPIC_TPL_TABLE'          => 'bb_topic_templates',
		'TOPICS_TABLE'             => 'bb_topics',
		'TOPICS_WATCH_TABLE'       => 'bb_topics_watch',
		'USER_GROUP_TABLE'         => 'bb_user_group',
		'USERS_TABLE'              => 'bb_users',
		'VOTE_DESC_TABLE'          => 'bb_vote_desc',
		'VOTE_RESULTS_TABLE'       => 'bb_vote_results',
		'VOTE_USERS_TABLE'         => 'bb_vote_voters',
		'WORDS_TABLE'              => 'bb_words',
