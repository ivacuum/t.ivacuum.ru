...
<frameset cols="180,*" rows="*" border="1" framespacing="1" frameborder="yes">
...
<table class="forumline" id="acp_main_nav">
	...
	<tr>
		<td><a href="{U_FORUM_INDEX}" target="_parent" class="med">{L_FORUM_INDEX}</a></td>
	</tr>
	<!-- BEGIN catrow -->
	<tr>
...
<table>
	<tr>
		<td><b>Clear Cache:</b></td>
		<td>
			<a href="{U_CLEAR_DATASTORE}">Datastore</a>,&nbsp;
			<a href="{U_CLEAR_TPL_CACHE}">Templates</a>,&nbsp;
			<a href="{U_UPDATE_NET_NEWS}">Net news</a>&nbsp;
		</td>
	</tr>
		<td><b>Update:</b></td>
		<td>
			<a href="{U_UPDATE_USER_LEVEL}">User levels</a>&nbsp;
		</td>
	</tr>
	</tr>
		<td><b>Synchronize:</b></td>
		<td>
			<a href="{U_SYNC_TOPICS}">Topics</a>,&nbsp;
			<a href="{U_SYNC_USER_POSTS}">User posts count</a>&nbsp;
		</td>
	</tr>
</table>
