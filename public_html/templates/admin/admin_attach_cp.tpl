...
<form method="post" action="{S_MODE_ACTION}">
  ...
  <tr>
	...
	<tr>
		<td class="row1" colspan="2"><span class="gen">{L_FILENAME}:</span><br /><span class="small">{L_WILDCARD_EXPLAIN}</span></td>
	...
	<tr>
		<td class="row1" colspan="2"><span class="gen">{L_COMMENT}:</span><br /><span class="small">{L_WILDCARD_EXPLAIN}</span></td>
	...
	<tr>
		<td class="row1" colspan="2"><span class="gen">{L_SEARCH_AUTHOR}:</span><br /><span class="small">{L_WILDCARD_EXPLAIN}</span></td>
