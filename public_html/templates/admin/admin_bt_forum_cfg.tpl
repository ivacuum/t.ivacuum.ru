...
<tr>
	<td>
		<h4>{L_BT_DL_LIST_EXPIRE}</h4>
		<table class="forumline wAuto med" style="margin: 4px 12px;">
			<col class="row1">
			<col class="row2">
			<tr>
				<td><h5>$bb_cfg['dl_will_days_keep']</h5></td>
				<td><?php echo $GLOBALS['bb_cfg']['dl_will_days_keep'] ?></td>
			</tr>
			<tr>
				<td><h5>$bb_cfg['dl_down_days_keep']</h5></td>
				<td><?php echo $GLOBALS['bb_cfg']['dl_down_days_keep'] ?></td>
			</tr>
			<tr>
				<td><h5>$bb_cfg['dl_complete_days_keep']</h5></td>
				<td><?php echo $GLOBALS['bb_cfg']['dl_complete_days_keep'] ?></td>
			</tr>
			<tr>
				<td><h5>$bb_cfg['dl_cancel_days_keep']</h5></td>
				<td><?php echo $GLOBALS['bb_cfg']['dl_cancel_days_keep'] ?></td>
			</tr>
		</table>
		<h6>{L_BT_DL_LIST_EXPIRE_EXPL}</h6>
	</td>
	<td>&nbsp;</td>
</tr>
<tr>
