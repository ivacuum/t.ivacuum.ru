...
<!-- FLAGHACK-start -->
	<tr>
	  ...
	  <tr>
			<td>{FLAG_SELECT}&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  		<td><img src="{STATIC_PATH}/i/flags/48/{FLAG_START}" name="user_flag" /></td>
		</tr></table>
	  </span></td>
	</tr>
<!-- FLAGHACK-end -->
	...
	<tr>
	  <td class="row1"><span class="gen">{L_SIGNATURE}</span><br />
		<span class="small">{L_SIGNATURE_EXPLAIN}<br />
		<br />
		{BBCODE_STATUS}<br />
	...
	<tr align="center">
	  ...
	  <table width="70%">
	  <tr>
			<td width="65%"><span class="small">{L_AVATAR_EXPLAIN}</span></td>
