...
<tr>
	<td colspan="2" class="td2	cat nav pad_4">
		&nbsp;<img class="topic_icon" src="{t.TOPIC_ICON}" alt="" style="vertical-align: text-top;">&nbsp;
...
<tr class="tCenter">
	...
	<td class="med"><!-- IF t.ATTACH --><p><span class="seedmed"><b>{t.SEEDERS}</b></span> | <span class="leechmed"><b>{t.LEECHERS}</b></span></p><p style="padding-top: 2px;">{t.SPEED}</p><!-- ELSE -->нет<!-- ENDIF --></td>
