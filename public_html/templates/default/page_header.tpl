...
<link rel="stylesheet" href="{STATIC_PATH}/i/t/css/style.css?v={$bb_cfg['css_ver']}" type="text/css" />
...
<script type="text/javascript" src="{STATIC_PATH}/i/t/js/main.js?v={$bb_cfg['js_ver']}"></script>
<link rel="stylesheet" href="{STATIC_PATH}/i/t/css/ui.css?v={$bb_cfg['css_ver']}" type="text/css" />
<!-- IF INCLUDE_BBCODE_JS -->
<script type="text/javascript" src="{STATIC_PATH}/i/t/js/bbcode.js?v={$bb_cfg['js_ver']}"></script>
<script type="text/javascript">
...
<![endif]-->
<!--[if lt IE 7]>
<link rel="stylesheet" href="{STATIC_PATH}/i/highslide/highslide-ie6.css" type="text/css" />
<script type="text/javascript">
...
<div id="logo" style="float: left;"><a href="{U_INDEX}"><!--<img src="{STATIC_PATH}/i/t/images/logo.png" alt="torrent.ivacuum.ru" title="torrent.ivacuum.ru" width="690" height="100">--><img src="{STATIC_PATH}/i/t/images/logo_snow.png" alt="torrent.ivacuum.ru" title="torrent.ivacuum.ru" width="689" height="100"></a></div>
<div style="float: right; margin-right: 0.3em;"><a href="https://lk.beeline.ru/"><img src="{STATIC_PATH}/i/t/images/beeline.png" alt="Трекер расположен в локальной сети Билайн-Калуга" title="Трекер расположен в локальной сети Билайн-Калуга" width="134" height="100" /></a></div>
