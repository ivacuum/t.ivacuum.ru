...
<tr>
	<td>{L_FLAG}:</td>
	<td>{FLAG_SELECT}&nbsp;&nbsp;<img src="{STATIC_PATH}/i/flags/48/{FLAG_START}" align="absmiddle" name="user_flag" /></td>
</tr>
<tr>
	<td>{L_OCCUPATION}:</td>
...
<tr>
	<td>{L_SIGNATURE}:<h6>{L_SIGNATURE_EXPLAIN}</h6><p class="small">{BBCODE_STATUS}<br />{SMILIES_STATUS}</p></td>
...
<tr>
	...
	<td><input type="submit" name="avatargallery" value="{L_SHOW_GALLERY}" class="btn" /></td>
</tr>
