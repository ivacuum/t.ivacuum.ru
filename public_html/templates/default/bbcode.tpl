...
<div class="q_wrap">
	<p class="q_head"><b>{USERNAME}</b> {L_WROTE}:</p>
	<div class="q">
<!-- END quote_username_open -->

<!-- BEGIN quote_open -->
<div class="q_wrap">
	<p class="q_head"><b>{L_QUOTE}:</b></p>
	<div class="q">
<!-- END quote_open -->
...
<!-- BEGIN name --><a name="{NAME}"></a><!-- END name -->

<!-- BEGIN url --><a href="{URL}" class="postLink">{DESCRIPTION}</a><!-- END url -->

<!-- BEGIN url_name --><a href="{URL}" class="postLink-name">{DESCRIPTION}</a><!-- END url_name -->
