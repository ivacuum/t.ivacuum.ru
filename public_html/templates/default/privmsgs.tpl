...
<tr>
	...
	<td class="tRight nowrap med">
		...
		<input type="submit" value="{L_GO}" name="submit_msgdays" class="btn btn-small" />
	</td>
</tr>
</table>
...
<tr>
	<td class="catBottom tRight pad_4" colspan="5">
		<div class="floatL">
			<input type="submit" name="deleteall" value="{L_DELETE_ALL}" class="btn btn-negative" />
		</div>
		<div class="floatR">
			<input type="submit" name="save" value="{L_SAVE_MARKED}" class="btn btn-primary" />&nbsp;&nbsp;
			<input type="submit" name="delete" value="{L_DELETE_MARKED}" class="btn btn-negative" />&nbsp;
		</div>
 </td>
</tr>
</table>
