...
<col class="row1 rel-title" width="20%">
<col class="row2 rel-inputs" width="80%">
<tr>
...
<tr>
	<td><b>{L_PICTURE}</b>:</td>
	<td><input type="text" name="msg[picture]" size="80" /> <span class="med">URL</span> <a class="med" href="{U_UPLOAD_IMAGE}" target="_blank"><b>Загрузить картинку</b></a></td>
</tr>
<tr>
	<td><b>{L_YEAR}</b>:</td>
