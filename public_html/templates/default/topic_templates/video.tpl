...
<tr>
	<td><b>Субтитры</b>:</td>
	<td>
		<select name="msg[subtitles]">
			<option value="">&raquo; {L_SELECT}</option>
			<option value="нет">нет</option>
			<option value="русские">русские</option>
			<option value="английские">английские</option>
			<option value="немецкие">немецкие</option>
			<option value="французские">французские</option>
		</select>
	</td>
</tr>
<tr>
