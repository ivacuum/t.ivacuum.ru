  ...
  <td class="row2" colspan="2" align="center"><span class="small">{L_SPLIT_TOPIC_EXPLAIN}</span></td>
	...
	<tr>
	 <td colspan="2" class="catBottom">
			<input class="btn" type="submit" name="delete_posts" value="{L_DELETE_POSTS}" style="width: 140px;" />
			<input class="btn" type="submit" name="split_type_all" value="{L_SPLIT_POSTS}" style="width: 210px;" />
			<input class="btn" type="submit" name="split_type_beyond" value="{L_SPLIT_AFTER}" style="width: 270px;" />
	 </td>
	</tr>
</table>
