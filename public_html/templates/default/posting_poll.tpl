...
<tr>
	...
	<td>
		...
		<input class="btn" type="submit" name="edit_poll_option" value="{L_UPDATE}" />&nbsp;
		<input class="btn btn-negative" type="submit" name="del_poll_option[{poll_option_rows.S_POLL_OPTION_NUM}]" value="{L_DELETE}" />
	</td>
</tr>
...
<tr>
	...
	<td>
		...
		<input class="btn" type="submit" name="add_poll_option" value="{L_ADD_OPTION}" />
	</td>
</tr>
<tr>
