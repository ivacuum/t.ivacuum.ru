	...
	<td class="row1" width="50%">
		...
		<div>
			<p class="input">
				...
				<input class="btn btn-small" type="button" value="{L_FIND_USERNAME}" onclick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400'); return false;" />
			</p>
			<p class="chbox med">
				<label>
				<input type="checkbox"
...
<tr>
	<td class="row1 pad_12">
		<p>
			<input type="text" name="search_username" value="{USERNAME}" class="post" /> <input type="submit" name="search" value="{L_SEARCH}" class="btn btn-small" />
		</p>
		...
		<p>
			...
			<input type="submit" class="btn btn-small btn-primary" onclick="refresh_username(this.form.username_list.options[this.form.username_list.selectedIndex].value);return false;" name="use" value="{L_SELECT}" />
		</p>
		<!-- ENDIF -->
		<br />
