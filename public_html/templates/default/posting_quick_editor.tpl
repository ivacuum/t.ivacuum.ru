...
<select name="codeAlign" class="text_size">
	<option value="left" selected="selected">Выравнивание:</option>
...
<div class="buttons mrg_4">
	...
	<input type="button" value="ImgLeft" name="codeImgLeft" title="ImageLeft" style="width: 60px;" />
	<input type="button" value="ImgRight" name="codeImgRight" title="ImageRight" style="width: 60px;" />
	...
	<textarea
		class="editor mrg_4" name="message" rows="16" cols="92"
...
<div class="mrg_4 tCenter">
	...
	<input class="btn btn-primary" title="Ctrl+Enter" type="submit" name="post" class="bold" value="{L_SUBMIT}" />
</div>
